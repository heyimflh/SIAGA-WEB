// Feature: auth-pages, Reducer preserves prior step data on BACK and forward navigation
//
...
//
// Rationale: mandates that navigating between steps does not
// drop user input; Requirements 7.9 and 8.9 specify the BACK button on Step 2
// and Step 3 must preserve previously entered Step 2 data; // extends this to re-renders. The reducer is the single source of truth for
...
// - SET_ROLE (different role) → territory
...
describe('registerReducer — navigation preserves prior step data', () => {
 ...
 // invariants: bucket data is byte-for-byte identical and
