...
export const mockData = Object.freeze({
  pilot_profile: {
    ...
    avatar: '/images/avatars/Pilot1.jpeg',
    is_verified: true,
    rating_avg: 4.8,
    total_reviews: 24,
  ...
  reviews: [
    {
      ...
      client_avatar: '/images/avatars/avatar-engineer.png',
      rating: 5,
    ...
    },
    {
      ...
      client_avatar: '/images/avatars/avatar-hse.png',
      rating: 5,
    ...
    },
    {
      ...
      client_avatar: '/images/avatars/avatar-researcher.png',
      rating: 4,
