 ...
 * Implementation covers dashboard layout, overview metrics, asset mapping, timeline,
 * bidding review, activity feed, and responsive shell.
 */
...
// Asset Map — lazy loaded to optimize initial bundle size (Mapbox GL JS ~700KB)
...
function ClientDashboardPage() {
 ...
 // Persist project selection to localStorage on every change
 useEffect(() => {
 ...
 // ─── State: mapFilter (per-session in-memory) ───────
