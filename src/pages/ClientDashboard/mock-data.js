 ...
 *     `perlu_perhatian`, dan `kritis` (Requirement 5.4 minimum 5-10).
 *
 *   - `bids` berisi 5-7 entries per `project_id`, dengan rating 0..5 dan
 *     mencakup nilai di atas/bawah threshold rating 2 (Requirement 7.2a)
 *     untuk memberikan demo material yang bermakna pada filter chip.
 *
 *   - `activities` berisi 10 entries dengan timestamp ISO datetime
 *     (Requirement 8.1).
 *
 * Module di-`Object.freeze` (deep) sehingga konsumen yang mencoba mutate
 * akan throw — menjamin invariant cross-section by construction
...
// Mencakup nilai di atas/bawah threshold rating 2 (Requirement 7.2a) agar
...
const bids = [
  // ---- Project P-001 (6 entries) -----------------------------------------
  {
    ...
    pilot_avatar: '/images/avatars/Pilot1.jpeg',
    siaga_verified: true,
    rating: 4.8,
    harga: 18_500_000,
    estimasi_hari: 5,
  ...
  },
  {
    ...
    pilot_avatar: '/images/avatars/Pilot2.jpeg',
    siaga_verified: true,
    rating: 4.5,
    harga: 21_000_000,
    estimasi_hari: 4,
  ...
  },
  {
    ...
    pilot_avatar: '/images/avatars/avatar-researcher.png',
  ...
  },
  {
    ...
    pilot_avatar: '/images/avatars/avatar-hse.png',
    siaga_verified: true,
    rating: 3.4,
    harga: 14_750_000,
    estimasi_hari: 8,
  ...
  },
  {
    ...
    pilot_avatar: '/images/avatars/avatar-engineer.png',
    siaga_verified: false,
    rating: 2.8,
    harga: 12_900_000,
    estimasi_hari: 9,
