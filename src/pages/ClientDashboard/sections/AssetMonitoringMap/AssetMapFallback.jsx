 ...
 * Requirements: 5.17, 5.18, 15.5, 15.5a
 *
 * Props:
 ...
 * Used as last-resort fallback (Requirement 15.5a).
 */
...
/**
 * Loading variant — spinner + loading text (Requirement 5.17).
 */
...
/**
 * Error variant — error message + text list of assets (Requirement 5.18).
...
function ErrorFallback({ assets }) {
  try {
    ...
    // If rendering fails, fall back to bare variant (Requirement 15.5a)
    return <BareFallback />;
  }
}
