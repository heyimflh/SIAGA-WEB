 ...
 * Each entry maps to a Bid_Sort_Key (Requirement 7.5).
 */
const SORT_COLUMNS = [
...
/**
 * Resolves the `aria-sort` attribute value for a column header (Requirement 13.9).
 ...
 * Each button carries `aria-sort` for accessibility (Requirement 13.9).
 */
