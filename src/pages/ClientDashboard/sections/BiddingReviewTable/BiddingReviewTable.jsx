 ...
 * Validates: Requirements 7.1, 7.2, 7.2a, 7.3, 7.4, 7.5, 7.6, 7.7, 7.8,
 *            7.9, 7.10, 7.10a, 7.14, 12.5, 13.8
 *
...
/**
 * Table column headers — maps to `<th scope="col">` (Requirement 13.8).
 */
const TABLE_COLUMNS = [
...
function BiddingReviewTable({
  ...
  // Empty state Requirement 7.14: no bids at all for this project
  ...
  // Pre-filter: always apply rating >= 2 threshold (Requirement 7.2a)
  ...
  // Empty state Requirement 7.10a: eligible bids exist but chips filter them all out
  ...
  return (
    <section className="bidding-review" aria-labelledby="bidding-title">
      ...
      {/* Empty state after filter (Requirement 7.10a) */}
      {isFilteredEmpty ? (
        ...
        /* Semantic table (Requirement 13.8) */
