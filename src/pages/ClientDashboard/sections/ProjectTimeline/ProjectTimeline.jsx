 ...
 * Validates: Requirements 6.1, 6.5, 6.6, 6.7, 6.8, 6.9, 6.10, 6.11, 15.1
 *
 * Props:
 ...
 * Requirement 6.5: urutan posted → bidding_open → pilot_selected →
...
function ProjectTimeline({ projects, selectedProjectId, onSelectProject }) {
  // Empty state: jika proyek_aktif kosong (Requirement 15.1)
  ...
  return (
    <section className="project-timeline" aria-label="Timeline proyek">
      ...
      {/* Timeline horizontal — Requirement 6.1, 6.5 */}
      <div
